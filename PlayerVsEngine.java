...
public class PlayerVsEngine{
    ...
    public void display1(){
        ...
        while (true) {
            ...
            System.out.print("Enter your placement (1-25): ");
            ...
            moveStack.push(new int[]{playerPos,1});
            printGameBoard(gameBoard);
            ...
            if (takeBackChoice.equalsIgnoreCase("y")) {
                if (!moveStack.isEmpty()) {
                    ...
                    playerPositions.remove(Integer.valueOf(position));
                ...
                while (playerPositions.contains(playerPos) || playerPositions.contains(playerPos)) {
                    System.out.println("Position taken! Enter a correct Position!");
                    playerPos = sc.nextInt();
                }
            ...
            Random r = new Random();
            int cpuPos = r.nextInt(25) + 1;
            while (playerPositions.contains(cpuPos) || cpuPositions.contains(cpuPos)) {
                System.out.println("Position taken! Enter a correct Position!");
                cpuPos = r.nextInt(25) + 1;
            }
    ...
    public void placePiece(char[][] gameBoard,int position, String user){
